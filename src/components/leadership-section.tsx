  ...
  const leaders = [
    {
      ...
      bio: "Pastor Michael has been leading Grace Community Church for over 15 years. He holds a Master of Divinity from Seminary and is passionate about expository preaching and pastoral care. He and his wife Sarah have three children and love serving this community.",
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=300&width=300",
      bio: "Pastor David leads our youth and young adult ministries with energy and authenticity. A former youth himself at Grace Community, he understands the unique challenges facing young people today and creates engaging, relevant programs.",
    ...
    },
    {
      ...
      image: "/placeholder.svg?height=300&width=300",
      bio: "Maria has been leading worship at Grace Community for over 10 years. With a degree in music ministry, she creates meaningful worship experiences that help people connect with God. She also directs our choir and leads music education programs.",
