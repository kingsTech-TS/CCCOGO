        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="text-center">
            <CardContent className="p-12">
              ...
              <h2 className="font-serif text-2xl font-bold text-gray-900 mb-4">Message Sent Successfully!</h2>
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <Card>
          <CardContent className="p-8">
            <h2 className="font-serif text-2xl font-bold text-gray-900 mb-6 text-center">Send Us a Message</h2>
